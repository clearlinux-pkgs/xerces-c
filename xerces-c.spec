...
Source0  : https://mirrors.advancedhosters.com/apache/xerces/c/3/sources/xerces-c-3.2.5.tar.xz
...
%prep
%setup -q -n xerces-c-3.2.5
cd %{_builddir}/xerces-c-3.2.5
pushd ..
cp -a xerces-c-3.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703175871
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libxerces-c-3.2.so
